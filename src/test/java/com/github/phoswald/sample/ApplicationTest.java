...
class ApplicationTest {
    ...
    void getIndexPage() {
        ...
        then().
            ...
            body(startsWith("<!doctype html>"), containsString("<title>Ratpack Sample Service</title>"));
    }
    ...
    @Disabled // TODO support XML, not only JSON
    @Test
    void postEchoXml() {
        given().
    ...
    @Test // TODO test all tasks REST endpoints
